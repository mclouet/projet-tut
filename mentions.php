...
<head>
    <meta charset="utf-8" />
    <title>Mentions légales &#124; CDLS</title>
    <meta name="description" content="Mentions légales : le site C'est dans le sac ! est édité par Cabadix" />
    <meta name="keywords" content="mentions légales, concours, sacs plastique, pollution, lots, gains, affiches, vidéos, clips audio" />
...
<body>
    ...
    <main>
        <h2 id="mentionsLegales" class="titreRose"> Nos mentions légales</h2>

        <p>Merci de lire attentivement les présentes modalités d'utilisation du présent site avant de le parcourir. En vous connectant sur ce site, vous acceptez les présentes modalités.</p>

        <h3>EDITEUR DU SITE</h3>
        <p>
            C'est dans le sac !
            <br/> par Cabadix
            <br/> 49 boulevard Antoine Gautier
            <br/> 53000 Laval
            <br/> France
        ...
        <p>
            ...
            <br/> Les oeuvres déposées sur le site sont soumisent aux droits d'auteur.
        ...
        <h3>DROIT D'ACCÈS</h3>
        <p>
            En application de la loi 78-17 du 6 janvier 1978 (modifiée par la loi 2004-801 du 6 août 2004 relative à la protection des personnes physiques à l'égard des traitements de données à caractère personnel) relative à l'informatique, aux fichiers et aux libertés, les internautes disposent d’un droit d’accès, de rectification, de modification et de suppression concernant les données qui les concernent personnellement. Ce droit peut être exercé par voie postale auprès de CABADIX, La Chesnaie 53600 CHATRE LA FORET ou par voie électronique à l’adresse email suivante : service-clients@cabadix.com Les informations personnelles collectées ne sont en aucun cas confiées à des tiers hormis pour l’éventuelle bonne exécution de la prestation commandée par l’internaute.
        </p>
        ...
        <p>
            ...
            <br/> Cabadix ne dispose d'aucun moyen pour contrôler les sites en connexion avec son site internet. Cabadix ne répond pas de la disponibilité de tels sites et sources externes, ni ne la garantit. Elle ne peut être tenue pour responsable de tout dommage, de quelque nature que ce soit, résultant du contenu de ces sites ou sources externes, et notamment des informations, produits ou services qu’ils proposent, ou de tout usage qui peut être fait de ces éléments. Les risques liés à cette utilisation incombent pleinement à l'internaute, qui doit se conformer à leurs conditions d'utilisation.
            <br/> Les utilisateurs, les abonnés et les visiteurs du site internet de Cabadix ne peuvent mettre en place un hyperlien en direction de ce site sans l'autorisation expresse et préalable de Cabadix.
            <br/> Dans l'hypothèse où un utilisateur ou visiteur souhaiterait mettre en place un hyperlien en direction du site internet de Cabadix, il lui appartiendra d'adresser un email accessible sur le site afin de formuler sa demande de mise en place d'un hyperlien. Cabadix se réserve le droit d’accepter ou de refuser un hyperlien sans avoir à en justifier sa décision.
            <br/>
        </p>

        <h3>RECHERCHE</h3>
        <p>
            En outre, le renvoi sur un site internet pour compléter une information recherchée ne signifie en aucune façon que Cabadix reconnaît ou accepte quelque responsabilité quant à la teneur ou à l'utilisation dudit site.
        </p>

        <h3>PRÉCAUTIONS D'USAGE</h3>
        <p>
            Il vous incombe par conséquent de prendre les précautions d'usage nécessaires pour vous assurer que ce que vous choisissez d'utiliser ne soit pas entaché d'erreurs voire d'éléments de nature nocive tels que virus, trojans, etc...
        </p>

        <h3>RESPONSABILITÉ</h3>
        <p>
            Aucune autre garantie n'est accordée à l'internaute, auquel incombe l'obligation de formuler clairement ses besoins et le devoir de s'informer. Si des informations fournies par Cabadix apparaissent inexactes, il appartiendra à l'internaute de procéder lui-même à toutes vérifications de la cohérence ou de la vraisemblance des résultats obtenus. Cabadix ne sera en aucune façon responsable vis à vis des tiers de l'utilisation par linternaute des informations ou de leur absence contenues dans ses produits y compris de son site Internet.
        </p>
